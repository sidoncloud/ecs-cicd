...
folders = {
    'orders': 'ecommerce-data/orders/process/',
    'order_items': 'ecommerce-data/order_items/process/',
    'products': 'ecommerce-data/products/process/'
}

ready_folders = {
    'orders': 'ecommerce-data/orders/ready/',
    'order_items': 'ecommerce-data/order_items/ready/',
    'products': 'ecommerce-data/products/ready/'
}
...
def list_files(bucket, prefix):
    ...
    files = [content['Key'] for content in response.get('Contents', []) if content['Key'] != prefix]
    return files
...
def main():
    # Retrieve the task token from environment variables
